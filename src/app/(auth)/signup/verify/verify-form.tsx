...
import { verifySignup, resendSignupCode, type FormState } from "@/lib/auth-actions";
...
export function SignupVerifyForm() {
  ...
  return (
    <form action={action} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        {pending ? t("auth.signupCreating") : t("auth.signupVerifySubmit")}
      </button>
